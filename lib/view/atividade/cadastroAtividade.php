		...
		<div class="col-xs-12">
			<form action="#" class="horizontal-form">
				...
				<div class="form-actions right">
					...
					<div class="col-sm-2"><button type="button" class="btn btn-lg btn-theme margintop10 pull-left" id="btSalva">Salvar</button></div>
					
					<!-- TODO: Validar se é edição ou nova atividade, se é nova, não exibir esse botão-->
					<div class="col-sm-3"><button type="button" class="btn btn-lg btn-red margintop10 pull-left" id="btRemove">Remove Atividade</button></div>
				</div>
			</form>
		</div>
	</div>
